...
/*   Updated: 2023/12/12 15:39:20 by kmorin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	execForm(void)
{
	try {
		std::cout << "Test grades to execute " << COLOR("PresidentialPardonForm", BLUE) << \
			" by having the sufficent grade and signing first:" << std::endl << std::endl;
...
void	execFormNotSigned(void)
{
	try {
		std::cout << "Test to execute " << COLOR("PresidentialPardonForm", BLUE) << \
			" without signing first:" << std::endl << std::endl;
		Bureaucrat	bureaucrat("a", 1);
...
void	execFormNotPerm(void)
{
	try {
		std::cout << "Test grades to sign and execute " << COLOR("PresidentialPardonForm", BLUE) << \
			" without the sufficient grade to sign or execute:" << std::endl << std::endl;
