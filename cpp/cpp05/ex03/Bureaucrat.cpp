...
/*   Updated: 2023/12/12 17:12:55 by kmorin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (SHOWMSG)
		std::cout << COLOR("Bureaucrat ", GREEN) << COLOR(this->_name, BLUE) << \
...
{
	if (SHOWMSG)
		std::cout << COLOR("Bureaucrat ", RED) << COLOR(this->_name, BLUE) << \
...
void	Bureaucrat::signForm(AForm& AForm)
{
	try {
		...
		std::cout << COLOR(this->getName(), BLUE) << " couldn't sign " << COLOR(AForm.getName(), MAGENTA) << \
