...
static const char	g_angle_top_left_char = 'o';
static const int	g_angle_top_right = 2;
static const char	g_angle_top_right_char = 'o';
static const int	g_angle_bottom_left = 3;
static const char	g_angle_bottom_left_char = 'o';
static const int	g_angle_bottom_right = 4;
static const char	g_angle_bottom_right_char = 'o';
